...
\begin{tabular}{ccc}
      \begin{subfigure}[t]{0.4\textwidth}
        ...
        \caption[]{Average latency\bigdataset{, \cw} - high recall algorithms}
        \label{fig:terms-scaling-high-avg}
      \end{subfigure}     

	\begin{subfigure}[t]{0.4\textwidth}
    	\includegraphics[width=\textwidth]{figures/latency_95th_percentile_clueweb.pdf}
	\caption{95\% latency\bigdataset{, \cw} - high recall algorithms}
...
Figures \ref{fig:terms-scaling-high-avg} and~\ref{fig:terms-scaling-high-95} compare \alg\hi\/ to the high-recall competitors. 
Figures \ref{fig:terms-scaling-low-avg} and~\ref{fig:terms-scaling-low-95} compare \alg\hi\/ to the low-recall competitors. 
}
