...
it performs very little processing per-posting. In order to achieve early termination, JASS applies heuristics that limit the fraction of processed terms. 
