...
and so the algorithm does not produce useful partial results before it completes.
...
Score-order algorithms have shown to be slower but  have more predictable performance than document-based ones~\cite{Crane:2017}.
%}
