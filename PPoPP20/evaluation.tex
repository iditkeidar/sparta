...
%\hline
 ...
 large & $12\!,010$ & $90\!,000+$ & $56\!,223$ & $7\!,410$ & $10\!,210$ & \inred{TBD} \\
...
on \cwten,  algorithms take between 7 seconds and \inred{1.5 minutes}, which is clearly unacceptable.
...
\bigdataset{
Figure~\ref{fig:terms-scaling}(c) depicts the mean latency for \cwten versus all algorithms.
}
%
...
%\hline
   ...
   \cwten & 9.6  & 1.8    & 0.38  & \inred{0.42} \\ %\hline
\end{tabular}
