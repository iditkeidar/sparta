...
This is exploited by our concurrent implementation, which stops sharing \DMap\ among the threads once it is sufficiently small, thereby eliminating the synchronization overhead altogether.
...
In addition to  posting list-traversing tasks, a task executing the 
...
analysis ignores. \alg\ further differs from pNRA in deferring updates to UB until the end of the segment, 
